...
| **Source PDF Location** | `public/forms/PagIbig - HLF858_ApplicationHomeEquityAppreciationLoan.pdf` |
| **Output API** | `POST /api/generate` body `{slug:"pagibig-hlf-858", values:{…}}` |
| **Field Count** | 48 |
| **Steps / Sections** | 4 |
...
|---|---|---|---|
| S1 | Loan & Identification | — | step 1, 11 fields |
| S2 | Permanent Address | — | step 2, 10 fields |
| S3 | Present Address | — | step 3, 10 fields |
| S4 | Employer | — | step 4, 17 fields |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| mid_no | Loan & Identification | Pag-IBIG MID Number | Text (short) | Yes | Yes | inputMode=numeric | 14 | Maybe | — | 0000-0000-0000 |  |
| housing_account_no | Loan & Identification | Housing Account No. | Text (short) | No | Yes |  | 14 | — | — | Office use |  |
| desired_loan_amount | Loan & Identification | Desired Loan Amount (PHP) | Text (short) | Yes | Yes | inputMode=numeric | — | — | — | 500000 |  |
| last_name | Loan & Identification | Last Name | Text (short) | Yes | Yes | UPPERCASE | — | — | — | DELA CRUZ |  |
| first_name | Loan & Identification | First Name | Text (short) | Yes | Yes | UPPERCASE | — | — | — | JUAN |  |
| ext_name | Loan & Identification | Name Extension | Dropdown | No | Yes | options(6) | — | — | — |  |  |
| middle_name | Loan & Identification | Middle Name | Text (short) | No | Yes | UPPERCASE | — | Maybe | — |  |  |
| maiden_middle_name | Loan & Identification | Maiden Middle Name (married women) | Text (short) | No | Yes | UPPERCASE | — | Maybe | — |  |  |
| dob | Loan & Identification | Date of Birth (mm/dd/yyyy) | Text (short) | Yes | Yes |  | 10 | — | — | 01/15/1990 |  |
| citizenship | Loan & Identification | Citizenship | Text (short) | Yes | Yes |  | — | — | — | Filipino |  |
| no_dependents | Loan & Identification | No. of Dependent/s | Text (short) | Yes | Yes | inputMode=numeric | 3 | — | — | 2 |  |
| perm_unit | Permanent Address | Permanent — Unit/Room/Floor/Building/Lot/Block/Phase/House No. | Text (short) | Yes | Yes |  | — | — | — |  |  |
...
| perm_business_tel | Permanent Address | Business Telephone Number (Permanent contact) | Text (phone) | No | Yes |  | — | — | — |  |  |
| pres_unit | Present Address | Present — Unit/Room/Floor/Building/Lot/Block/Phase/House No. | Text (short) | No | Yes |  | — | — | — |  |  |
...
| pres_cellphone | Present Address | Cellphone Number | Text (phone) | Yes | Yes | inputMode=tel | 11 | — | — | 09171234567 |  |
| email_address | Present Address | Email Address | Text (email) | Yes | Yes | inputMode=email | — | — | — |  |  |
| years_stay_present | Present Address | Years of Stay in Present Home Address | Text (short) | No | Yes | inputMode=numeric | 3 | — | — |  |  |
| occupation | Employer | Occupation | Text (short) | Yes | Yes |  | — | — | — |  |  |
| tin | Employer | Taxpayer Identification No. (TIN) | Text (short) | Yes | Yes | inputMode=numeric | 12 | Maybe | — |  |  |
| sss_gsis | Employer | SSS / GSIS ID Number | Text (short) | No | Yes |  | — | — | — |  |  |
| employer_business_tel | Employer | Employer Business Telephone | Text (phone) | No | Yes |  | — | — | — |  |  |
...
| employer_email | Employer | Employer / Business Email | Text (email) | No | Yes |  | — | — | — |  |  |
| position_dept | Employer | Position & Department | Text (short) | Yes | Yes |  | — | — | — |  |  |
| preferred_time_contact | Employer | Preferred Time to be Contacted (Employer) | Text (short) | No | Yes |  | — | — | — |  |  |
| place_assignment | Employer | Place of Assignment | Text (short) | No | Yes |  | — | — | — |  |  |
...
See `src/lib/pdf-generator.ts` constant `PAGIBIG_HLF_858_FIELD_COORDS` (or matching `*_FIELD_COORDS`).
