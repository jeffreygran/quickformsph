...
const PERSONAS: Record<string, string>[] = [
  // ── Sample A — IMPROVED (community-acquired pneumonia, moderate risk) ──
  {
    ...
    pe_heent: 'Essentially normal',
    pe_chest_lungs: 'Rales/crackles/rhonchi',
    pe_cvs: 'Essentially normal',
    pe_abdomen: 'Essentially normal',
    pe_gu: 'Essentially normal',
    pe_skin: 'Essentially normal',
    pe_neuro: 'Essentially normal',
  ...
  // ── Sample B — TRANSFERRED (surgical referral) ──
  {
    ...
    pe_heent: 'Essentially normal',
    pe_chest_lungs: 'Essentially normal',
    pe_cvs: 'Essentially normal',
    pe_abdomen: 'Abdomen tenderness, Abdominal rigidity',
    pe_gu: 'Essentially normal',
    pe_skin: 'Essentially normal',
    pe_neuro: 'Essentially normal',
  ...
  // ── Sample C — EXPIRED (septic shock decompensation; referred case) ──
  {
    ...
    pe_heent: 'Pale conjunctivae, Dry mucous membrane',
    pe_chest_lungs: 'Decreased breath sounds, Rales/crackles/rhonchi',
    pe_cvs: 'Muffled heart sounds, Irregular rhythm',
    pe_abdomen: 'Abdomen tenderness',
    pe_gu: 'Essentially normal',
    pe_skin: 'Cyanosis/mottled skin, Cold clammy skin, Edema/swelling, Pale nailbeds, Weak pulses',
    pe_neuro: 'Poor/altered memory, Poor coordination',
