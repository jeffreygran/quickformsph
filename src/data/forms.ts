...
const pagibigSlf089: FormSchema = {
  ...
  fields: [
    ...
    { id: 'no_maiden_middle_name', label: 'No Maiden Middle Name (married women)', type: 'text', required: false,
      placeholder: 'Maiden surname if applicable', autoUppercase: true, step: 1 },
    ...
    { id: 'place_of_birth', label: 'Place of Birth', type: 'text', required: true,
      placeholder: 'QUEZON CITY', autoUppercase: true, step: 1 },

    // ── Step 2: Personal Info ──
    { id: 'mothers_maiden_name', label: "Complete Mother's Maiden Name", type: 'text', required: true,
      placeholder: 'MARIA REYES SANTOS', autoUppercase: true, step: 2 },
    { id: 'sex', label: 'Sex', type: 'dropdown', required: true,
    ...
    { id: 'perm_home_tel', label: 'Home Telephone Number', type: 'tel', required: false,
      placeholder: '02-12345678', step: 3 },
    { id: 'perm_subdivision', label: 'Subdivision', type: 'text', required: false, step: 3 },
    { id: 'perm_barangay', label: 'Barangay', type: 'text', required: true,
      placeholder: 'SAN JOSE', step: 3 },
    { id: 'perm_city', label: 'Municipality / City', type: 'text', required: true,
      placeholder: 'QUEZON CITY', step: 3 },
    { id: 'perm_province', label: 'Province / State / Country', type: 'text', required: true,
      placeholder: 'METRO MANILA', step: 3 },
    ...
    { id: 'perm_email', label: 'Email Address', type: 'email', required: true,
      placeholder: 'juan@example.com', inputMode: 'email', step: 3 },
    ...
    { id: 'pres_unit', label: 'Unit/Floor/Building/Lot/Block/Phase/House No.', type: 'text', required: false,
      placeholder: 'Same as Permanent if blank', step: 4 },
    { id: 'pres_street', label: 'Street Name', type: 'text', required: false, step: 4 },
    { id: 'pres_employee_id', label: 'Employee ID Number', type: 'text', required: false,
      placeholder: 'EMP-12345', step: 4 },
    { id: 'pres_nature_of_work', label: 'Nature of Work', type: 'text', required: true,
      placeholder: 'Software Engineer', step: 4 },
    { id: 'pres_subdivision', label: 'Subdivision', type: 'text', required: false, step: 4 },
    { id: 'pres_barangay', label: 'Barangay', type: 'text', required: false, step: 4 },
    { id: 'pres_city', label: 'Municipality / City', type: 'text', required: false, step: 4 },
    { id: 'pres_province', label: 'Province / State / Country', type: 'text', required: false, step: 4 },
    ...
    { id: 'desired_loan_amount', label: 'Desired Loan Amount (PHP)', type: 'text', required: true,
      placeholder: '50000', inputMode: 'numeric', step: 5 },
    ...
    { id: 'employer_address_line', label: "Employer Address — Unit/Bldg/Street", type: 'text', required: true,
      placeholder: '5th Floor ACME Bldg, Ayala Avenue', step: 5 },
    { id: 'source_of_fund', label: 'Source of Fund', type: 'text', required: true,
      placeholder: 'Salary', step: 5 },
    { id: 'employer_subdivision', label: 'Employer Subdivision', type: 'text', required: false, step: 5 },
    { id: 'employer_barangay', label: 'Employer Barangay', type: 'text', required: true, step: 5 },
    { id: 'employer_city', label: 'Employer City', type: 'text', required: true, step: 5 },
    { id: 'employer_province', label: 'Employer Province / Country', type: 'text', required: true, step: 5 },
    ...
    { id: 'beneficiary_last', label: "Beneficiary's Last Name", type: 'text', required: true,
      placeholder: 'DELA CRUZ', autoUppercase: true, step: 5 },
    { id: 'beneficiary_first', label: "Beneficiary's First Name", type: 'text', required: true,
      placeholder: 'MARIA', autoUppercase: true, step: 5 },
    ...
    { id: 'student_id_no', label: 'Student Number / Identification Number', type: 'text', required: false,
      placeholder: 'For educational loans only', step: 5 },
...
const pagibigSlf065: FormSchema = {
  ...
  steps: [
    ...
    { label: 'Present Address', fieldIds: ['pres_unit', 'pres_business_tel', 'pres_nature_of_work', 'pres_street', 'pres_subdivision', 'pres_barangay', 'pres_city', 'pres_province', 'pres_zip', 'loan_term', 'desired_loan_amount'] },
    { label: 'Employer / Loan', fieldIds: ['employer_name', 'loan_purpose', 'employer_address_line', 'employer_subdivision', 'employer_barangay', 'employer_city', 'employer_province', 'employer_zip', 'employee_id_no', 'date_of_employment', 'source_of_fund', 'payroll_bank_name', 'signature_date'] },
  ],
  fields: [
    // ── Step 1: Identification ──
    { id: 'mid_no', label: 'Pag-IBIG MID No.', type: 'text', required: true,
    ...
    { id: 'email', label: 'Email Address', type: 'email', required: true,
      placeholder: 'juan@example.com', inputMode: 'email', step: 2 },
    ...
    { id: 'perm_sss_gsis', label: 'SSS / GSIS No.', type: 'text', required: false,
      placeholder: '12-3456789-0', step: 3 },
    ...
    { id: 'desired_loan_amount', label: 'Desired Loan Amount (PHP)', type: 'text', required: true,
      placeholder: '50000', inputMode: 'numeric', step: 4 },
    ...
    { id: 'source_of_fund', label: 'Source of Fund', type: 'text', required: true,
      placeholder: 'Salary', step: 5 },
    { id: 'payroll_bank_name', label: 'Payroll Account Bank / Branch', type: 'text', required: false,
      placeholder: 'BDO Makati', step: 5 },
    { id: 'signature_date', label: 'Date Signed (mm/dd/yyyy)', type: 'text', required: true,
      placeholder: '04/23/2026', maxLength: 10, step: 5 },
  ],
};
...
const pagibigHlf868: FormSchema = {
  ...
  steps: [
    { label: 'Identification', fieldIds: ['mid_no', 'housing_account_no', 'last_name', 'first_name', 'ext_name', 'middle_name', 'maiden_middle_name', 'dob', 'citizenship', 'proportionate_share'] },
    ...
    { label: 'Present Address', fieldIds: ['pres_unit', 'pres_street', 'pres_subdivision', 'pres_barangay', 'pres_city', 'pres_province', 'pres_zip', 'pres_business_tel', 'pres_cellphone', 'email_address', 'years_stay_present', 'tin', 'sss_gsis'] },
    { label: 'Employer', fieldIds: ['occupation', 'employer_name', 'employer_address_line', 'employer_subdivision', 'employer_barangay', 'employer_city', 'employer_province', 'employer_zip', 'employer_business_tel', 'employer_email', 'position_dept', 'preferred_time_contact', 'place_assignment', 'years_employment', 'no_dependents', 'signature_date'] },
  ],
  fields: [
    // Step 1: Identification
    ...
    { id: 'perm_unit', label: 'Unit/Room/Floor/Building/Lot/Block/Phase/House No.', type: 'text', required: true,
      placeholder: 'Unit 4B, 123 Bldg', step: 2 },
    { id: 'perm_street', label: 'Street Name', type: 'text', required: true,
      placeholder: 'Rizal St', step: 2 },
    { id: 'perm_subdivision', label: 'Subdivision', type: 'text', required: false, step: 2 },
    { id: 'perm_barangay', label: 'Barangay', type: 'text', required: true,
      placeholder: 'SAN JOSE', step: 2 },
    { id: 'perm_city', label: 'Municipality / City', type: 'text', required: true,
      placeholder: 'QUEZON CITY', step: 2 },
    { id: 'perm_province', label: 'Province / State / Country', type: 'text', required: true,
      placeholder: 'METRO MANILA', step: 2 },
    { id: 'perm_zip', label: 'ZIP Code', type: 'text', required: true,
    ...
    { id: 'pres_unit', label: 'Unit/Room/Floor/Building/Lot/Block/Phase/House No.', type: 'text', required: false,
      placeholder: 'Same as Permanent if blank', step: 3 },
    ...
    { id: 'employer_email', label: 'Employer / Business Email Address', type: 'email', required: false,
      placeholder: 'hr@acme.com', step: 4 },
...
const pagibigHlf068: FormSchema = {
  ...
  description:
    'Apply for a Pag-IBIG Housing Loan. MVP fills the BORROWER\'S DATA section (identification, addresses, employer) on page 1. Loan particulars, property details, and spouse/co-borrower sections deferred to iteration 2.',
  steps: [
    { label: 'Identification', fieldIds: ['mid_no', 'housing_account_no', 'desired_loan_amount', 'last_name', 'first_name', 'ext_name', 'middle_name', 'citizenship', 'dob'] },
    { label: 'Permanent Address', fieldIds: ['perm_unit', 'perm_street', 'perm_subdivision', 'perm_barangay', 'perm_city', 'perm_province', 'perm_zip'] },
    { label: 'Present Address & Contacts', fieldIds: ['pres_unit', 'pres_street', 'pres_subdivision', 'pres_barangay', 'pres_city', 'pres_province', 'pres_zip', 'pres_cellphone', 'email_address', 'years_stay_present', 'sss_gsis'] },
    { label: 'Employer', fieldIds: ['employer_name', 'tin', 'employer_address_line', 'occupation', 'employer_subdivision', 'employer_barangay', 'employer_city', 'employer_province', 'employer_zip', 'position_dept', 'years_employment', 'signature_date'] },
  ],
  fields: [
    ...
    { id: 'housing_account_no', label: 'Housing Account Number (HAN), if existing', type: 'text', required: false,
      placeholder: 'Office use', maxLength: 14, step: 1 },
    { id: 'desired_loan_amount', label: 'Desired Loan Amount (PHP)', type: 'text', required: true,
      placeholder: '1500000', inputMode: 'numeric', step: 1 },
    { id: 'last_name', label: 'Last Name', type: 'text', required: true,
      placeholder: 'DELA CRUZ', autoUppercase: true, step: 1 },
    { id: 'first_name', label: 'First Name', type: 'text', required: true,
      placeholder: 'JUAN', autoUppercase: true, step: 1 },
    ...
    { id: 'perm_unit', label: 'Permanent — Unit/Floor/Building/Lot/Block/Phase/House No.', type: 'text', required: true, step: 2 },
    { id: 'perm_street', label: 'Street Name', type: 'text', required: true, step: 2 },
    { id: 'perm_subdivision', label: 'Subdivision', type: 'text', required: false, step: 2 },
    { id: 'perm_barangay', label: 'Barangay', type: 'text', required: true, step: 2 },
    { id: 'perm_city', label: 'Municipality / City', type: 'text', required: true, step: 2 },
    ...
    { id: 'pres_unit', label: 'Present — Unit/Floor/Building/Lot/Block/Phase/House No.', type: 'text', required: false, step: 3 },
    { id: 'pres_street', label: 'Street Name', type: 'text', required: false, step: 3 },
    { id: 'pres_subdivision', label: 'Subdivision', type: 'text', required: false, step: 3 },
    { id: 'pres_barangay', label: 'Barangay', type: 'text', required: false, step: 3 },
    { id: 'pres_city', label: 'Municipality / City', type: 'text', required: false, step: 3 },
    ...
    { id: 'email_address', label: 'Email Address', type: 'email', required: true,
      inputMode: 'email', step: 3 },
    { id: 'years_stay_present', label: 'Years of Stay in Present Home Address', type: 'text', required: false,
      inputMode: 'numeric', maxLength: 3, step: 3 },
    { id: 'sss_gsis', label: 'SSS / GSIS ID Number', type: 'text', required: false,
      placeholder: '12-3456789-0', step: 3 },

    { id: 'employer_name', label: 'Employer / Business Name', type: 'text', required: true, step: 4 },
    { id: 'tin', label: 'Taxpayer Identification No. (TIN)', type: 'text', required: true,
      inputMode: 'numeric', maxLength: 12, step: 4 },
    { id: 'employer_address_line', label: 'Employer Address — Unit/Floor/Bldg/Street', type: 'text', required: true, step: 4 },
    { id: 'occupation', label: 'Occupation', type: 'text', required: true,
      placeholder: 'Software Engineer', step: 4 },
    { id: 'employer_subdivision', label: 'Employer Subdivision', type: 'text', required: false, step: 4 },
    ...
    { id: 'position_dept', label: 'Position & Department', type: 'text', required: true, step: 4 },
    { id: 'years_employment', label: 'Years in Employment / Business', type: 'text', required: true,
      inputMode: 'numeric', maxLength: 3, step: 4 },
    { id: 'signature_date', label: 'Date Signed (mm/dd/yyyy)', type: 'text', required: true,
      placeholder: '04/23/2026', maxLength: 10, step: 4 },
  ],
};
...
// ─── Form Catalog ─────────────────────────────────────────────────────────────
export const FORMS: FormSchema[] = [hqpPff356, philhealthPmrf, philhealthClaimForm1, philhealthClaimForm2, philhealthPmrfForeignNatl, philhealthClaimSignatureForm, pagibigPff049, pagibigSlf089, pagibigSlf065, pagibigHlf868, pagibigHlf858, pagibigHlf068];
