...
const pagibigHlf068: FormSchema = {
  ...
  fields: [
    ...
    { id: 'last_name', label: 'Last Name', type: 'text', required: true,
      placeholder: 'DELA CRUZ', autoUppercase: true, step: 3 },
    { id: 'first_name', label: 'First Name', type: 'text', required: true,
      placeholder: 'JUAN', autoUppercase: true, step: 3 },
    { id: 'ext_name', label: 'Name Extension', type: 'dropdown', required: false,
      options: ['N/A', 'Jr.', 'Sr.', 'II', 'III', 'IV'], step: 3 },
    { id: 'middle_name', label: 'Middle Name', type: 'text', required: false,
      autoUppercase: true, step: 3 },
    { id: 'citizenship', label: 'Citizenship', type: 'text', required: true,
      placeholder: 'Filipino', step: 3 },
    { id: 'dob', label: 'Date of Birth (mm/dd/yyyy)', type: 'text', required: true,
    ...
    { id: 'perm_unit', label: 'Permanent — Unit/Floor/Building/Lot/Block/Phase/House No.', type: 'text', required: true, step: 4 },
    { id: 'perm_street', label: 'Street Name', type: 'text', required: true, step: 4 },
    { id: 'perm_subdivision', label: 'Subdivision', type: 'text', required: false, step: 4 },
    { id: 'perm_barangay', label: 'Barangay', type: 'text', required: true, step: 4 },
    { id: 'perm_city', label: 'Municipality / City', type: 'text', required: true, step: 4 },
    { id: 'perm_province', label: 'Province / State / Country', type: 'text', required: true, step: 4 },
    { id: 'perm_zip', label: 'ZIP Code', type: 'text', required: true, inputMode: 'numeric', maxLength: 4, step: 4 },

    { id: 'pres_unit', label: 'Present — Unit/Floor/Building/Lot/Block/Phase/House No.', type: 'text', required: false, step: 5 },
    { id: 'pres_street', label: 'Street Name', type: 'text', required: false, step: 5 },
    { id: 'pres_subdivision', label: 'Subdivision', type: 'text', required: false, step: 5 },
    { id: 'pres_barangay', label: 'Barangay', type: 'text', required: false, step: 5 },
    { id: 'pres_city', label: 'Municipality / City', type: 'text', required: false, step: 5 },
    { id: 'pres_province', label: 'Province / State / Country', type: 'text', required: false, step: 5 },
    ...
    { id: 'email_address', label: 'Email Address', type: 'email', required: true,
      inputMode: 'email', step: 5 },
    { id: 'years_stay_present', label: 'Years of Stay in Present Home Address', type: 'text', required: false,
      inputMode: 'numeric', maxLength: 3, step: 5 },
    { id: 'sss_gsis', label: 'SSS / GSIS ID Number', type: 'text', required: false,
      placeholder: '12-3456789-0', step: 5 },
    { id: 'home_ownership', label: 'Home Ownership (Present)', type: 'dropdown', required: false,
    ...
    { id: 'employer_name', label: 'Employer / Business Name', type: 'text', required: true, step: 6 },
    { id: 'tin', label: 'Taxpayer Identification No. (TIN)', type: 'text', required: true,
      inputMode: 'numeric', maxLength: 12, step: 6 },
    { id: 'employer_address_line', label: 'Employer Address — Unit/Floor/Bldg/Street', type: 'text', required: true, step: 6 },
    { id: 'occupation', label: 'Occupation', type: 'text', required: true,
      placeholder: 'Software Engineer', step: 6 },
    { id: 'employer_subdivision', label: 'Employer Subdivision', type: 'text', required: false, step: 6 },
    { id: 'employer_barangay', label: 'Employer Barangay', type: 'text', required: true, step: 6 },
    { id: 'employer_city', label: 'Employer City', type: 'text', required: true, step: 6 },
    { id: 'employer_province', label: 'Employer Province / Country', type: 'text', required: true, step: 6 },
