...
const philhealthPmrf: FormSchema = {
  ...
  fields: [
    ...
    },
    {
      ...
      hint: 'Document proving your monthly income (e.g., payslip, ITR, COE)', maxLength: 14, inputMode: 'numeric',
      step: 5,
    },
  ],
};
...
const philhealthClaimForm1: FormSchema = {
  ...
  fields: [
    ...
    // ── Step 5: Employer Certification (employed members only) ──
    {
      ...
      inputMode: 'numeric',
      hint: 'Skip if self-employed, OFW, or unemployed', maxLength: 14,
      step: 5,
    },
    {
      id: 'employer_contact',
...
const philhealthClaimForm2: FormSchema = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'e.g., 279 E. Rodriguez Sr. Blvd.', maxLength: 60, autoUppercase: true,
      step: 1,
    },
    {
      id: 'hci_city',
    ...
    },
    {
      ...
      required: false,
      optional_note: 'Only if referred',
      placeholder: 'e.g., 123 Rizal Ave.', maxLength: 60, autoUppercase: true,
      step: 3,
    },
    {
    ...
    },
    {
      ...
      required: false,
      optional_note: 'Only if Transferred/Referred',
      placeholder: 'e.g., Taft Ave.', maxLength: 60, autoUppercase: true,
      step: 4,
    },
    {
...
const philhealthPmrfForeignNatl: FormSchema = {
  ...
  fields: [
    ...
    { id: 'philhealth_number', label: 'PhilHealth Number', type: 'text', required: false,
      optional_note: 'Leave blank if new applicant', placeholder: '12-345678901-2', maxLength: 14, inputMode: 'numeric', step: 1 },
    { id: 'acr_icard_number', label: 'ACR I-card Number', type: 'text', required: false,
      optional_note: 'For aliens registered with BI', maxLength: 24, step: 1 },
    { id: 'pra_srrv_number', label: 'PRA SRRV Number', type: 'text', required: false,
      optional_note: 'For PRA-registered foreign retirees', maxLength: 24, step: 1 },
    { id: 'last_name', label: 'Last Name', type: 'text', required: true, maxLength: 80, step: 1 },
    { id: 'first_name', label: 'First Name', type: 'text', required: true, maxLength: 80, step: 1 },
    { id: 'middle_name', label: 'Middle Name', type: 'text', required: false,
      optional_note: 'Leave blank if none', maxLength: 80, step: 1 },
    ...
    { id: 'nationality', label: 'Nationality', type: 'text', required: true,
      placeholder: 'e.g., American, Japanese', maxLength: 60, autoUppercase: true, step: 1 },
    ...
    { id: 'philippine_address_line1', label: 'Philippine Address — Line 1', type: 'text',
      required: true, placeholder: 'Unit / Building / Street', maxLength: 150, autoUppercase: true, step: 2 },
    { id: 'philippine_address_line2', label: 'Philippine Address — Line 2', type: 'text',
      required: false, optional_note: 'Barangay, City, Province, ZIP', maxLength: 150, autoUppercase: true, step: 2 },
    { id: 'contact_phone', label: 'Contact / Phone Number', type: 'tel', required: true,
      placeholder: '+63 9XX XXX XXXX', maxLength: 20, step: 2 },
    ...
    { id: 'signature_printed_name', label: 'Printed Name (Signatory)', type: 'text', required: true,
      hint: 'Full printed name matching the signature', maxLength: 80, step: 4 },
...
const philhealthClaimSignatureForm: FormSchema = {
  ...
  fields: [
    ...
    { id: 'member_middle_name', label: 'Member — Middle Name', type: 'text', required: false, autoUppercase: true, maxLength: 80, inputMode: 'numeric', step: 1 },
    ...
    { id: 'patient_last_name', label: 'Patient — Last Name', type: 'text', required: true, autoUppercase: true, maxLength: 80, step: 2 },
    { id: 'patient_first_name', label: 'Patient — First Name', type: 'text', required: true, autoUppercase: true, maxLength: 80, step: 2 },
    { id: 'patient_ext_name', label: 'Patient — Name Extension', type: 'text', required: false,
      optional_note: 'Leave blank if none', autoUppercase: true, maxLength: 6, step: 2 },
    { id: 'patient_middle_name', label: 'Patient — Middle Name', type: 'text', required: false, autoUppercase: true, maxLength: 80, inputMode: 'numeric', step: 2 },
    ...
    { id: 'employer_contact_no', label: 'Employer Contact No.', type: 'tel', required: false,
      optional_note: 'Leave blank if not employed', maxLength: 20, step: 3 },
...
const pagibigSlf065: FormSchema = {
  ...
  fields: [
    ...
    { id: 'desired_loan_amount', label: 'Desired Loan Amount (PHP)', type: 'text', required: true,
      placeholder: '50000', inputMode: 'numeric', maxLength: 14, step: 4 },
...
const bir1904: FormSchema = {
  ...
  fields: [
    ...
    { id: 'name_suffix', label: '7A. Suffix (Jr/Sr/III)', type: 'text', required: false, maxLength: 6, autoUppercase: true, step: 1 },
    ...
    { id: 'spouse_tin', label: '23. Spouse TIN — 12 digits (trailing 5 zeros are agency-reserved)', type: 'text', required: false, maxLength: 12, inputMode: 'numeric', step: 5 },
    ...
    { id: 'wa_title', label: '33. Title / Position of Signatory', type: 'text', required: false, maxLength: 40, autoUppercase: true, step: 7 },
  ],
};
