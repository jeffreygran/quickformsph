...
function SettingsTab() {
  ...
  useEffect(() => {
    fetch('/api/admin/gcash-settings')
      .then(r => r.json())
      .then((d: { gcash_number: string; gcash_name: string; qr_url: string | null; maya_qr_url?: string | null }) => {
  ...
  return (
    <div className="max-w-lg space-y-4">
      ...
      <div className="rounded-2xl bg-white border border-gray-200 p-6 space-y-4">
        ...
        <p className="text-xs text-gray-500">Upload a QR code image so users can scan and pay directly. Shown as an alternative in Payment Details.</p>
        {qrUrl ? (
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handleRemoveQR} disabled={uploadBusy} className="text-xs text-red-600 border border-red-200 rounded-xl px-4 py-2 hover:bg-red-50 disabled:opacity-50">
                Remove
              </button>
            </div>
          </div>
        ...
        {mayaQrUrl ? (
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handleRemoveMayaQR} disabled={mayaUploadBusy} className="text-xs text-red-600 border border-red-200 rounded-xl px-4 py-2 hover:bg-red-50 disabled:opacity-50">Remove</button>
            </div>
          </div>
        ) : (
          <label className="flex flex-col items-center justify-center gap-2 w-full rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 py-8 cursor-pointer transition-colors">
